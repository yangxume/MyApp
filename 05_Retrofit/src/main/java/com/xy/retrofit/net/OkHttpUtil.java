...
import com.xy.retrofit.application.MyApplication;
import com.xy.retrofit.net.interceptor.HeaderInterceptor;
import com.xy.retrofit.net.interceptor.HttpLoggingInterceptor;
import com.xy.retrofit.net.interceptor.LoggingInterceptor;
import com.xy.retrofit.util.AppConstant;
import com.xy.retrofit.util.ToastUtils;
...
//            if (bodyString.contains(AppConstant.LOGIN_OHTHER)) {
...
//            } else if (bodyString.contains(AppConstant.SESSION_TIMEOUT)) {
