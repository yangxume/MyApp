...
public class ActivityX5_FullScreen extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		webView.addJavascriptInterface(new WebViewJavaScriptFunction() {
			...
			public void onX5ButtonClicked() {
				ActivityX5_FullScreen.this.enableX5FullscreenFunc();
			}

			@JavascriptInterface
			public void onCustomButtonClicked() {
				ActivityX5_FullScreen.this.disableX5FullscreenFunc();
			}

			@JavascriptInterface
			public void onLiteWndButtonClicked() {
				ActivityX5_FullScreen.this.enableLiteWndFunc();
			}

			@JavascriptInterface
			public void onPageVideoClicked() {
				ActivityX5_FullScreen.this.enablePageVideoFunc();
			}
		}, "Android");
