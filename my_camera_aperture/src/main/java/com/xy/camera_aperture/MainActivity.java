package com.xy.camera_aperture;
...
/**
 * desc : https://blog.csdn.net/ming_csdn_/article/details/70154381
 */
public class MainActivity extends AppCompatActivity {


    private CameraApertureView myView;
    ...
    //MyView左右距离屏幕的距离（意思是MyView左右两边一共空了500）
    myViewPaddingTop = 300;
    // MyView上下距离屏幕的距离（意思是MyView上下两边一共空了500）
...
//        把屏幕设置成横屏
        ...
        myView = (CameraApertureView) findViewById(R.id.myView);
