...
import com.xy.animation.utils.KJAnimations;
import com.xy.animation.R;
import com.xy.animation.utils.RecordButtonUtil;
...
public class RecordButton extends RelativeLayout {
    ...
    private void init() {
        ...
        topFlag = findViewById(R.id.recordview_linearlayout);
        ...
        tvStartrecord = (TextView) findViewById(R.id.tv_startrecord);
        initPlayButtonEvent();
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                viewToInit();
//			mTvRecordTime.setText("按下录音");
                tvStartrecord.setVisibility(View.VISIBLE);
        ...
        mImgPlay.setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    tvStartrecord.setVisibility(View.GONE);
